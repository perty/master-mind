// elm-watch hot {"version":"1.0.2","webSocketPort":64612}
"use strict";
(() => {
...
${variant}`;
  ...
  var VERSION = "1.0.2";
  var TARGET_NAME = "build";
  var INITIAL_ELM_COMPILED_TIMESTAMP = Number(
    "1666099620757"
  );
  var ORIGINAL_COMPILATION_MODE = "standard";
  var WEBSOCKET_PORT = "64612";
...
var $author$project$Main$makeCombination = F4(
	function (peg1, peg2, peg3, peg4) {
		return $elm$core$Array$fromList(
			_List_fromArray(
				[peg1, peg2, peg3, peg4]));
	});
var $author$project$Main$init = {
	correct: A4($author$project$Main$makeCombination, $author$project$Main$Red, $author$project$Main$Green, $author$project$Main$Yellow, $author$project$Main$Blue),
	guesses: _List_Nil
};
